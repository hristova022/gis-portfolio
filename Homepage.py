...
st.set_page_config(
    page_title="Homepage | GIS Portfolio",
    page_icon="🏠",
    layout="wide"
)
...
with col1:
    ...
    Interactive case studies demonstrating expertise in **geospatial analysis** and **data science**, 
    ...
    - **Data Science & ML:** Predictive modeling, statistical analysis, data-driven decision making
...
I'm a GIS professional with expertise in data science and spatial analysis. 
My work combines geospatial techniques with machine learning to create data-driven solutions 
